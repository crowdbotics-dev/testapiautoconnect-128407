...
## Project Structure
    ...
    ├── testapiautoconnect_128407  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_128407`
...
2. Clone this repo and `cd testapiautoconnect_128407`
